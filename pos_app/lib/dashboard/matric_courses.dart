...
class MatricCourses extends StatefulWidget {
  const MatricCourses({super.key});

  @override
  State<MatricCourses> createState() => _MatricCoursesState();
}

class _MatricCoursesState extends State<MatricCourses> {
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
              ...
              builder: (BuildContext context,
                  AsyncSnapshot<List<MatricDatum>>? snapshot) {
                if (snapshot!.hasData) {
                  List<MatricDatum>? courses = snapshot.data;
